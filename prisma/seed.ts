...
async function seed() {
  ...
  const products = [
    ...
    // Tenun Songket Products
    {
      name: 'Songket Bunga Emas Ngada',
      slug: 'songket-bunga-emas-ngada',
      category: 'songket',
      price: 1250000,
      description: 'Songket bunga emas khas Ngada dengan motif floral yang ditenun menggunakan benang emas asli. Ditenun secara manual oleh penenun songket berpengalaman dengan teknik sungkit tradisional yang membutuhkan ketelitian luar biasa. Setiap helai benang emas disungkit satu per satu, menghasilkan kain mewah yang melambangkan kemakmuran dan keluhuran budaya Ngada. Cocok untuk acara adat besar, pernikahan, atau koleksi tekstil berharga.',
      ikmName: 'IKM Songket Bajawa Makmur',
      artisanInfo: 'IKM Songket Bajawa Makmur berlokasi di Desa Bajawa, Kecamatan Bajawa. Dipimpin oleh Ibu Theresia Woe, IKM ini beranggotakan 8 perempuan penenun songket yang menguasai teknik sungkit benang emas turun-temurun.\n\nSongket Ngada dikenal dengan motif bunga, kuda, dan zebra yang sarat makna filosofis. Proses pembuatan satu kain songket mewah memakan waktu 1-3 bulan, tergantung kompleksitas motif.\n\nBenang emas yang digunakan berkualitas tinggi dan diimpor khusus untuk memastikan kilau dan keawetan kain. IKM ini telah berpartisipasi dalam berbagai pameran tekstil nasional.',
      whatsappNumber: defaultWa,
      marketplaceUrl: null,
      specifications: 'Ukuran: 200 x 75 cm\nBahan: Benang katun + benang emas asli\nBerat: ~450 gram\nTeknik: Sungkit tangan (ATBM)',
      imageUrl: '/images/products/songket-bunga.png',
      isFeatured: true,
    },
    {
      name: 'Songket Kuda Ngada',
      slug: 'songket-kuda-ngada',
      category: 'songket',
      price: 1500000,
      description: 'Songket motif kuda dari Ngada, simbol keperkasaan dan kehormatan dalam budaya Ngada. Motif kuda merupakan salah satu motif paling dihormati karena kuda memiliki peran penting dalam tradisi dan upacara adat Ngada. Ditenun dengan benang emas pada kain dasar warna gelap, menghasilkan kontras mewah yang memukau. Kain ini sering diwariskan sebagai pusaka keluarga.',
      ikmName: 'IKM Songket Langa',
      artisanInfo: 'IKM Songket Langa berbasis di Desa Langa, Kecamatan Bajawa. Dikelola oleh Ibu Maria Gele, IKM ini memiliki 6 anggota penenun songket senior yang telah menenun selama lebih dari 20 tahun.\n\nMotif kuda adalah salah satu motif paling kompleks dan dimuliakan dalam tradisi songket Ngada. Penenun harus memiliki keahlian khusus untuk menghasilkan motif kuda yang simetris dan tajam.\n\nIKM ini juga membina penenun muda agar tradisi songket motif kuda tidak punah. Karya mereka banyak dicari kolektor tekstil tradisional NTT.',
      whatsappNumber: defaultWa,
      marketplaceUrl: null,
      specifications: 'Ukuran: 210 x 80 cm\nBahan: Benang katun + benang emas\nBerat: ~500 gram\nTeknik: Sungkit tangan (ATBM)\nWarna dasar: Hitam/Merah tua',
      imageUrl: '/images/products/songket-kuda.png',
      isFeatured: true,
    },
    {
      name: 'Songket Zebra Ngada',
      slug: 'songket-zebra-ngada',
      category: 'songket',
      price: 980000,
      description: 'Songket motif zebra Ngada dengan pola geometris yang modern namun tetap berakar pada tradisi. Motif zebra melambangkan keseimbangan antara kekuatan dan kelembutan. Ditenun dengan kombinasi benang emas dan benang katun berwarna kontras, menghasilkan kain yang cocok untuk penggunaan modern maupun adat. Pilihan tepat untuk busana formal, selendang pernikahan, atau hiasan interior.',
      ikmName: 'IKM Songket Benteng Tengah',
      artisanInfo: 'IKM Songket Benteng Tengah berada di Desa Benteng Tengah, Kecamatan Bajawa. Dikoordinir oleh Ibu Yuliana Boa, IKM ini beranggotakan 7 penenun yang fokus pada motif songket kontemporer dengan sentuhan modern.\n\nSelain mempertahankan motif tradisional, IKM ini juga berinovasi mengembangkan motif baru yang lebih diminati pasar muda. Motif zebra adalah salah satu inovasi yang tetap menggunakan teknik sungkit tradisional namun dengan pola yang lebih kontemporer.\n\nProduk IKM ini telah dipasarkan ke Bali, Jakarta, dan beberapa kota besar di Indonesia.',
      whatsappNumber: defaultWa,
      marketplaceUrl: null,
      specifications: 'Ukuran: 200 x 75 cm\nBahan: Benang katun + benang emas\nBerat: ~430 gram\nTeknik: Sungkit tangan (ATBM)\nMotif: Zebra geometris',
      imageUrl: '/images/products/songket-zebra.png',
      isFeatured: false,
    },
  ];
